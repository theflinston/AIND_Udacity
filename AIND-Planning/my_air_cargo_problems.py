...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        for action in self.actions_list:
            in_pos = len(set(action.precond_pos) - set(kb.clauses)) == 0
            in_neg = len(set(action.precond_neg) - set(kb.clauses)) == len(action.precond_neg)
    ...
    def result(self, state: str, action: Action):
        ...
        #verify fluent states for the current state
        ...
        #verify fluent state for the action
